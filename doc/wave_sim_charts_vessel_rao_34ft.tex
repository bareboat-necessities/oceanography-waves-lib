...
\title{34-Foot Fin-Keel Sailboat: Vessel RAO Simulation Charts}
\author{Mikhail Grushinskiy}
\date{Release 1.2.3}
\newcommand{\VesselChart}[2]{
  \begin{figure}[H]\centering
  \resizebox{\textwidth}{!}{\input{vessel_rao_34ft_#1.pgf}}
  \caption{#2}
...
estimated 34-foot fin-keel sailboat at zero forward speed with fixed heading
and an IMU at the center of gravity. Waterline length is 8.500 m, beam 3.521 m,
and draft 1.821 m. Natural periods for heave, pitch, and roll are 2.645, 3.085,
and 3.857 seconds, with damping ratios 0.45, 0.35, and 0.22.

The hull dimensions scale from the 28-foot preset by 34/28; all response
...
The complete dataset is \texttt{sim-data-files-vessel-rao-34ft.zip}; its internal
